...
# read tif file
dataset = rasterio.open('/Users/mateocintron/Desktop/earth therminal equator/CHELSA_bio01_1981-2010_V.2.1.tif')
...
width_of_earth = abs(degrees_latitude_max - degrees_latitude_max2)
...
width_of_earth2 = abs(degrees_latitude_max3 - degrees_latitude_max4)
